...
\title[Article Title]{Formalization of Gyrovector Spaces as Models of Hyperbolic Geometry and Special Relativity}
...
\author*[1,2]{\fnm{Jelena} \sur{Markovi\' c}}\email{jelena.markovic@matf.bg.ac.rs}

\author*[1,3]{\fnm{Filip} \sur{Mari\' c}}\email{filip.maric@matf.bg.ac.rs}
...
\affil[2]{ORCID: 0009-0007-4797-2666}
\affil[3]{ORCID: 0000-0001-7219-6960}
...
There have been attempts to describe some fragments of physics with the help of mathematical logic. A very interesting paper about giving the axioms of relativistic theory is \cite{logical-relativity}, but it lacks a computer formalization, making it a potential path for future work. Another theoritical paper about the axiomatization of physics is A. Kapustin's paper\cite{lifeq}. Regarding formalization, we are familiar with Jacques Fleuriot's paper involving both geometry and physics\cite{jf}. As far as we know, this is the first attempt to formalize gyrovector spaces.
